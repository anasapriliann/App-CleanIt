...
<html lang="en">
  ...
  <!-- Navbar -->
     <nav class="navbar navbar-expand-lg  bg-primary">
        <div class="container">
        <a class="navbar-brand text-white" href="#"><strong></strong></a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" 
        aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"></span>
        </button>

        <div class="collapse navbar-collapse navbar-dark" id="navbarNav"><strong>
          <div class="container">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
             <!-- <a class="nav-link mr-4" href="#">TENTANG KAMI</a>
            </li>
            <li class="nav-item">
              <a class="nav-link mr-4" href="admin.php">ADMIN</a>
            </li> -->
            <li class="nav-item">
              <a class="nav-link mr-4" href="koneksi.php?proses_logout">KELUAR</a>
            </li>
          </ul>
        </div>
       </div>
            ...
            <div class="card brder-dark">
              ...
              <div class="card-body">
               ...
               <label class="card-text harga"><strong>Rp.</strong> <?php echo number_format($result['harga']); ?></label><br>
                <a href="paket.php" class="btn btn-success btn-sm btn-block ">Pilih</a>
              </div>
            </div>
          </div>
          <?php endforeach ?>
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          ...
          <label class="font-weight-bold">Follow Us @anasaprilian </label>
